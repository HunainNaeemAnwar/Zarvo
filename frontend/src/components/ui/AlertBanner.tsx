...
export function AlertBanner(props: AlertBannerProps) {
  ...
  const messageUr = props.messageUr;
  const messageEn = props.messageEn;
  const lang = props.lang;
  const onDismiss = props.onDismiss;

  const defaultType = type ?? "warning";
  const defaultLang = lang ?? "ur";
  ...
  const isUrdu = defaultLang === "ur";
  const isWarning = defaultType === "warning";
